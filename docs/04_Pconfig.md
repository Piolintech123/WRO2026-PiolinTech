...
*   **For more information regarding removal, please refer to:** [2.2 Core Processing Shift](WRO2026-PiolinTech/docs/02_HComponents.md).
...
*   **For the main documentation on Computer Vision Functions and Error Rates:** [Performance Testing and Analytics documentation](WRO2026-PiolinTech/docs/10_PTesting&Analysis.md).
